...
write.table(first_line[1, 1], "Idiogram-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE)
write.table(first_line[1, 2], "Idiogram-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)
write.table(first_line[1, 3], "Idiogram-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)
write.table(first_line[1, 4], "Idiogram-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)
write.table(first_line[1, 5], "Idiogram-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)

write.table(data$rect, "Idiogram-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)
write.table(karyotype$path, "Idiogram-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)
write.table(karyotype$text, "Idiogram-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)
write.table(data1_legend$data1_legend, "Idiogram-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)
write.table(legend1_text[1,1], "Idiogram-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)
write.table(legend1_text[1,2], "Idiogram-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)
write.table(data_interval$shape, "Idiogram-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)
write.table(data2_legend$shape, "Idiogram-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)
write.table(data2_legend$name, "Idiogram-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)

last_line <- data.frame(paste("</svg>"))
write.table(last_line[1, 1], "Idiogram-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)
